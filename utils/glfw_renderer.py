...
class GlfwRenderer:
    ...
    def __init__(self, window, game_view_window, attach_callbacks=True):
        ...
        self._game_view_window = game_view_window
    ...
    def mouse_callback(self, window, button, action, mods):
        ...
        self.io.mouse_down[0] = button == glfw.MOUSE_BUTTON_1 and not action == glfw.RELEASE
        self.io.mouse_down[1] = button == glfw.MOUSE_BUTTON_2 and not action == glfw.RELEASE
        self.io.mouse_down[2] = button == glfw.MOUSE_BUTTON_3 and not action == glfw.RELEASE
        self.io.mouse_down[3] = button == glfw.MOUSE_BUTTON_4 and not action == glfw.RELEASE
        self.io.mouse_down[4] = button == glfw.MOUSE_BUTTON_5 and not action == glfw.RELEASE

        if not self.io.want_capture_mouse and self.io.mouse_down[1]:
    ...
    def process_inputs(self):
        ...
        io.display_fb_scale = self._compute_fb_scale(window_size, fb_size)
    ...
    def _compute_fb_scale(self, window_size, frame_buffer_size):
