...
class Camera:
    def __init__(self, position: glm.vec2):
        ...
        self.clear_color = glm.fvec4(1.0, 1.0, 1.0, 1.0)
        self._projection_size = glm.fvec2(
            self._projection_width, self._projection_height
        )
    ...
    def adjust_projection(self):
        ...
        self._projection_matrix = glm.ortho(
            0.0,
            self._projection_size.x * self._zoom,
            0.0,
            self._projection_size.y * self._zoom,
            0.0,
            100.0,
        )
    ...
    def get_view_matrix(self):
        ...
        self._view_matrix = glm.lookAt(
            glm.fvec3(self._position.x, self._position.y, 20.0),
